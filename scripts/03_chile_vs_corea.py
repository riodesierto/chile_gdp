...
# Korea
korea = gdp[gdp['Code'] == 'KOR']
korea = korea.T
korea = korea.iloc[2:].reset_index()  # Convierte el índice en columna y elimina la fila del encabezado
korea.columns = ["año", "gdp"]  # Renombra las columnas
korea = korea.iloc[:-1]  # Elimina la última fila
korea = korea.dropna()  # Elimina columnas completamente vacías
korea["año"] = korea["año"].astype(float)  # Convierte el año en entero
...
# Set Legend
ax.legend(['Chile', 'Mundial', 'Korea'], loc=(0,1.09), ncol=3, frameon=False, handletextpad=1, handleheight=1)
...
plt.savefig('images/chile_growth_index_KR.png',    # Set path and filename
